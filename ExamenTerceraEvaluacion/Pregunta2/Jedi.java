package ExamenTerceraEvaluacion.Pregunta2;
...
public class Jedi extends Maestro {
    ...
    public void ataca(Maestro m) {
        if (this.vida <= 0) {
            ...
            System.out.println(this.nombre + " ataca a " + m.getNombre() + ". Le quita " + (3 * this.fuerza)
                    + " puntos de vida (daño triple).");
            m.setVida(m.getVida() - (3 * this.fuerza));
        } else {
            System.out.println(
                    this.nombre + " ataca a " + m.getNombre() + ". Le quita " + this.fuerza + " puntos de vida.");
